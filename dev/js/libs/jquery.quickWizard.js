(function ($) {
    ...
    $.fn.quickWizard = function (options, callback) {
        ...
        var settings = {
            'prevButton': '#form-wizard-prev',//'<button id="form-wizard-prev" type="button">Previous</button>',
            'nextButton': '#form-wizard-next',//'<button id="form-wizard-next" type="button">Next</button>',
